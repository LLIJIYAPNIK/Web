...
def products():
    data = {
        "category_id": json_methods.get_all_category(),
        "all_category": json_methods.get_all_category(),
        "products_id": json_methods.get_products_id(),
        "all_products": json_methods.get_all_products()
    }
    print(data)
