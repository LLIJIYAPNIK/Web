...
# Маршрут для отображения всех опубликованных постов
@app.route('/all_posts', methods=['GET'])
def all_posts():
    # Получаем номер страницы из запроса или устанавливаем значение по умолчанию
    page = request.args.get('page', 1, type=int)

    # Фильтруем посты по полю is_published
    ...
    # Генерируем URL для кнопок навигации
    ...
    # Рендерим шаблон и передаем данные для отображения
